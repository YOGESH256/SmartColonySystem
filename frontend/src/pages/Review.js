            ...
            <div class="col-lg-4 col-md-5 col-sm-4 offset-md-1 offset-sm-1 col-12 mt-4">
                <form id="algin-form" onSubmit={submitHandler}>
                    <div class="revw-form-group">
                        <h4 class="revw-h4">Leave a comment</h4> <label class="revw-label" for="message">Message</label> <textarea name="msg" onChange={(e) => setMessage(e.target.value)} id="" msg cols="30" rows="5" class="form-control review-form-bg" style={{}}></textarea>
                    </div>
                    <div>
