...
<section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-4 offset-md-1 offset-sm-1 col-12 mt-4">
                <form id="algin-form">
                    ...
                    <div class="form-group"> <label for="name">Name</label> <input type="text" name="name" id="fullname" class="form-control form-bgf"/> </div>
                    <div class="form-group btn-group dropdown"> <label for="email">Reviewe Type</label> <button type="button" class=" btn-danger">Select your choice</button>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="#">Room Issue</a></li>
