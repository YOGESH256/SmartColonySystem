...
export default function Comment() {
  return (
    <div className="justify-content-center" id="com-main">
            ...
            <div className="d-flex flex-row">
              ...
              <div className="d-flex flex-column ms-2">
                ...
                <p className="comment-text">
                  ...
                  Ut dictum facilisis dui, non faucibus dolor sit amet lorem
                  auctor vitae. className aptent taciti sociosqu ad litora
