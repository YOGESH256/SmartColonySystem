...
import {workerlogin , workerregister , getWorker , workerValidation,getWorkerByService,order,getAllOrders,getWorkerOrders} from '../controllers/ServicesController.js'
...
router.post('/getWorkerOrders',getWorkerOrders)
